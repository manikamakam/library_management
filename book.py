...
#         if book:
#             title = input(f"Enter new title for {book.title} (leave blank to keep current): ")
#             author = input(f"Enter new author for {book.author} (leave blank to keep current): ")
#             if title:
#                 book.title = title
#             if author:
#                 book.author = author
...
#         search_term = input("Enter book ISBN or title to search: ")
